...
public class BlogPostController {
  ...
  public BlogPostDto getPostDetails(@PathVariable(value = "id") Long id) {
  ...
  public BlogPostInfo createPost(@Valid @RequestBody BlogPostDto blogPostDto) {
    ...
    blogPostDto.setAuthor(userMapper.toInfo(user));
